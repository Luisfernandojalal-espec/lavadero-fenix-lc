...
import { db, uid, stamp, TIPOS_VEHICULO, precioServicio, esLavador, medioPagoGasto, labelMedioGasto, decidirTocaTurno } from '../db'
...
export default function Lavadores({ embedded }) {
  ...
  function abrirPago(t) { setPagoA(t); setMontoPago(Math.max(0, statsDe(t.id).saldo)); setPagoMedio('efectivo'); setPagoEfMixto(0); setPagoFuera(false) }
